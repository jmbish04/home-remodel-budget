function createRenovationTracker() {
  ...
  var baselineItems = [
    ...
    ["Lower Level Core", "Lower Level Full Bathroom Gut Remodel", 28500.00, "Down-to-the-studs modernization. Layout incorporates material calculations from Specs sheet for wall/floor tile overlays."],
    ...
    ["Upper Level Core", "House-Wide Premium Hardwood Subfloor & Flooring", 42000.00, "Remove old flooring, check flat-level tolerances, and install new select-grade hardwood across entire upper footprint and complete stairs."],
  ...
  var s1Data = [
    ...
    ["UL Layout Mod", "Jack-and-Jill Bathroom Transformation & Relocation", 32500.00, "Relocate hall bath into old kitchen envelope, converting to a dual-access Jack-and-Jill suite. Taps directly into wet-bar framing sewer connections."],
    ...
    ["UL Cosmetic", "Primary Bathroom Comprehensive Luxury Remodel", 48000.00, "Down to studs overhaul of primary suite bathroom according to modern design guidelines."]
  ];
  buildScenarioTab("Scenario 1 - Downstairs South (Slab Cut)", s1Data);

  // ==========================================
  // TAB 4: SCENARIO 2 DATA
  // ==========================================
  var s2Data = [
    ...
    ["UL Layout Mod", "Jack-and-Jill Bathroom Transformation & Relocation", 32500.00, "Identical to Scenario 1: Relocate bath to old kitchen zone using wet bar lines."],
    ...
    ["UL Cosmetic", "Primary Bathroom Comprehensive Luxury Remodel", 48000.00, "Identical to Scenario 1: Complete luxury teardown and rebuild of ensuite."]
  ];
  buildScenarioTab("Scenario 2 - Downstairs North (Stack Tap)", s2Data);

  // ==========================================
  // TAB 5: SCENARIO 3 DATA
  // ==========================================
  var s3Data = [
    ...
    ["UL Cosmetic", "Primary Ensuite Full Premium Remodel", 48000.00, "Complete down-to-studs cosmetic overhauling of primary master bathroom."],
    ["UL Cosmetic", "Upper Hall Bathroom Full Premium Remodel", 28500.00, "Complete cosmetic overhaul of the upstairs hall bathroom in its original structural layout."]
  ];
  buildScenarioTab("Scenario 3 - Upstairs U-Shape Open", s3Data);

  // ==========================================
  // TAB 6: SCENARIO 4 DATA
  // ==========================================
  var s4Data = [
    ["LL Core Integration", "Lower Level Layout Retention Realities", 0.00, "Lower space footprint left unchanged. Handled entirely via the baseline polish/seal concrete execution and bathroom overhaul."],
